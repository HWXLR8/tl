...
void IconContainer::addExistingIcon(CharacterIcon* icon) {
  icons_.push_back(icon);
}

void IconContainer::removeIcon(CharacterIcon* icon) {
...
CharacterIcon* IconContainer::getActiveIcon(glm::vec2 mouse_pos) {
  for (auto& icon : icons_) {
...
bool IconContainer::isActive(glm::vec2 mouse_pos) {
